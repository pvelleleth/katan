			...
			<div class="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_320px]">
					...
					<div class="rounded-3xl border-2 border-wood/10 p-8 shadow-xl glass-panel">
						<div class="mb-6 flex items-center justify-between">
							<h2 class="text-2xl font-black text-wood-dark"
								>Players ({players.length}/{settings.maxPlayers})</h2
							>
							<span
				...
				<aside>
					{#if data.playerId}
						...
						<div class="sticky top-[112px] rounded-3xl border-2 border-wood/10 p-6 shadow-xl glass-panel">
							<h2 class="mb-5 text-xl font-black text-wood-dark">Game Settings</h2>
							<div class="flex flex-col gap-5">
								<div>
									<label for="turnTime" class="mb-1 block text-xs font-bold text-wood-light uppercase tracking-wider"
										>Turn time (sec)</label
									>
									<input
										id="turnTime"
										...
										disabled={!isHost}
										class="w-full rounded-xl border border-wood/20 bg-white/80 px-3 py-2 text-sm font-semibold text-wood-dark focus:border-ocean/50 focus:outline-none focus:ring-2 focus:ring-ocean/20 disabled:cursor-not-allowed disabled:opacity-70 disabled:bg-wood/5"
									/>
								</div>
								<div>
									<label for="maxPlayers" class="mb-1 block text-xs font-bold text-wood-light uppercase tracking-wider"
										>Max players</label
									>
									<input
										id="maxPlayers"
								...
								<div>
									<label for="victoryPoints" class="mb-1 block text-xs font-bold text-wood-light uppercase tracking-wider"
								...
								<div class="flex flex-col gap-3 pt-2">
									<label class="flex items-center gap-3 {!isHost ? 'cursor-default' : 'cursor-pointer'}">
										<input
											type="checkbox"
